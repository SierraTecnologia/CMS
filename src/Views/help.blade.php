        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-dark card-help">
                    ...
                    <div class="card-body">
                    SierraTecnologia CMS comes with a very basic API. It provides access to all published public facing data. You can define details in your CMS API middleware.
                    <br><br>
                    Out of the box SierraTecnologia CMS API requires use of the <code>api-token</code> set in the config of your app.
                    <br><br>
...
/cms/api/widgets/{id}</pre>
                ...
                <div class="card card-dark card-help">
                    ...
                    <div class="card-body">
                        SierraTecnologia CMS comes with a few console commands to handle things like module building and publishing
                        <br><br>
                        You can also build simple modules which will run inside CMS. Simply provide a table name you wish to manage and allow CMS to build a CRUD structure that works inside SierraTecnologia CMS's module directory.
                        <br><br>
                ...
                <div class="card card-dark card-help">
                    ...
                    <div class="card-body">
                        The commmand for generating custom modules for the SierraTecnologia CMS is:
                        <br><br>
                ...
                <div class="card card-dark card-help">
                    ...
                    <div class="card-body">
                        SierraTecnologia CMS lets you create a composer package from a module. So if you want to can offer them to others rather easily.
                        <br><br>
                ...
                <div class="card card-dark card-help">
                    ...
                    <div class="card-body">
                        SierraTecnologia CMS automatically builds you a sample of the controllers, and views for your application's pages, blog, faqs, etc. You can run the following services as method calls or use the blade directives listed below:
                        <br><br>
                ...
                <div class="card card-dark card-help">
                    ...
                    <div class="card-body">
                        By default the SierraTecnologia CMS has the default theme. You can override this in the <code>config/cms.php</code> file. The theme has the namespace of: <code>cms-frontend::</code>, and has some <b>Blade</b> directives such as:
                        <br><br>
                        ...
                        <br>
                        You can generate new themes and publish thier public assets. Consult the <a target="_blank" href="https://docs.sierratecnologia.ca/cms/themes">documentation</a> for more information about themes etc.
                    </div>
                </div>
            </div>
        </div>

...
class ImagesTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->withoutEvents();
        factory(\SierraTecnologia\Cms\Models\Image::class)->create();
    }
    ...
    */
    ...
    public function testStore()
    {
        ...
        $image = (array) factory(\SierraTecnologia\Cms\Models\Image::class)->make(['id' => 2]);
        $image['location'] = [
            [
    ...
    {
        $image = (array) factory(\SierraTecnologia\Cms\Models\Image::class)->make(['id' => 3, 'title' => 'dumber']);
